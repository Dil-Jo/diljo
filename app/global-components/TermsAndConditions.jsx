  ...
  return <>
    ...
    <div className="modal">
      <div className="modal-box relative">
        <div className="relative bg-white rounded-lg shadow darkremoveg-gray-700">
          ...
          <div className="flex items-start justify-between p-4 border-b rounded-t darkremoveorder-gray-600">
            <h3 className="text-xl font-bold text-gray-900 darkremoveext-white">
              Terms and Conditions
            </h3>
          </div>
          <div className="p-6 space-y-6">
            <p className="text-base leading-relaxed text-gray-500 darkremoveext-gray-400">
            ...
            <ul className={"list-disc"}>
              <li className={"text-base leading-relaxed text-gray-500 darkremoveext-gray-400"}>
