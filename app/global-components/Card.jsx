...
export default function Card(props) {
  ...
  return (
    <div
      className="border-2 border-slate-100 group z-0 mx-auto mt-10 w-full max-w-md flex-shrink-0 transform bg-gradient-to-r from-slate-50 to-zinc-100 rounded-3xl pb-8 shadow-lg duration-200 hover:-translate-y-2">
      <div
