  ...
  return (
    <div className="w-full md:h-screen h-full md:flex md:flex-row overflow-auto">
      ...
      <div className={"flex  flex-col md:w-4/6 w-full md:justify-center my-10"}>
        <Form updateForm={updateForm} fullForm={fullForm} setStage={setStage} stage={stage} submitForm={submitForm} />
      </div>
    </div>
  );
};
...
const MessageComponent = ({ stage }) => {
  ...
  return (
    <>
      ...
      <div
        className="w-full h-full flex flex-col justify-center md:justify-start"
      >
...
const Form = ({ stage, setStage, updateForm, fullForm, submitForm }) => {
  ...
  switch (stage) {
    case 0:
      return <div>Welcome <button onClick={nextStage}>Begin</button></div>
    case 1:
      return <Form1 next={nextStage} fullForm={fullForm} updateForm={updateForm} prev={prevStage} />;
    case 2:
      return <Form2 next={nextStage} fullForm={fullForm} updateForm={updateForm} prev={prevStage} />;
    case 3:
      return <Form3 next={nextStage} fullForm={fullForm} updateForm={updateForm} prev={prevStage} />;
    case 4:
...
const Finish = ({ submitForm }) => {
  return (
    <div className="flex flex-col justify-center items-center">
      <button onClick={submitForm}>Click here to submit</button>
