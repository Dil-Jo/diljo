...
const Comp1 = () => {
  ...
  return (
    <>
      <div className="h-screen  mt-8 flex bg-slate-400 rounded-l-3xl">
        <div className="w-2/6 flex flex-col justify-center items-center">
          <h2 id="head1" className="text-3xl font-medium text-slate-700 sm:text-4xl mb-8 tracking-tighter">Let's lend a
            hand to someone,</h2>
          ...
          <div className="flex flex-col">
            <div className="flex">
              <div className="flex flex-col mt-24 ml-24 h-5/6">
                <div className="flex">
                  <label htmlFor="reason" className=" font-normal text-lg mr-6 mt-2">Select a reason for collecting
                    funds:</label>
                  <select id="reason" name="reason"
                          className="h-11 dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52">
                  ...
                  <div className="flex ml-6">
                    <div className="form-control">
                      <label className="label cursor-pointer">
                        ...
                        <input type="radio" name="radio-10" onChange={() => setIdentity("anonymous")}
                               className="radio checked:bg-red-700" checked />
                      </label>
                    </div>
                    <div className="form-control">
                      <label className="label cursor-pointer">
                        <span className="label-text mx-4">Visible</span>
                        <input type="radio" name="radio-10" onChange={() => setIdentity("visible")}
                ...
                <div className="mt-11 flex flex-col">
                  ...
                  <input type="text" placeholder="Title goes here" className="mt-4 input input-bordered w-full max-w-xs"
                         onChange={(e) => setTitle(e.target.value)} />
                </div>
                <div className="mt-11 flex flex-col">
                  <h1 className="font-normal text-lg">Description for the Fundraiser:</h1>
                  <textarea style={{ resize: "none", width: "30vw", height: "30vh" }}
              ...
              <div className="flex flex-col w-[40rem] h-[48rem] ml-20 mt-10">
                <div id="imgbg" className="bg-white w-3/6 h-2/4 mt-14 ml-24 rounded-md">
                  <input type="file" style={{ display: "none" }} accept="image/*" className="inputfile "
                         id="embedpollfileinput" onChange={(e) => onimg(e)} />
                  <label htmlFor="embedpollfileinput"
                         className="flex flex-col items-center justify-center cursor-pointer">
                    <Image style={{ position: "relative", top: "18rem" }} src={upload} alt="Upload sign"
