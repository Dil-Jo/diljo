...
const Form1 = ({ next, updateForm }) => {
  ...
  return (
    <form className="flex flex-col mt-24 ml-24" onSubmit={handleSubmit}>
      <div className="flex">
        <label htmlFor="reason" className=" font-normal text-lg mr-6 mt-2">
          Select a reason for collecting funds:
        </label>
        <select
          id="reason"
          name="reason"
          ...
          <div className="form-control">
            <label className="label cursor-pointer">
              ...
              <input
                ...
                name="radio-10"
                value="anonymous"
                checked={form["radio-10"] === "anonymous"}
                className="radio checked:bg-red-700"
                onChange={handleChange}
              />
            </label>
          </div>
