  ...
  return (
    <form className="h-full w-full flex flex-col" onSubmit={handleSubmit}>
      <div className="flex mt-24 ml-24 h-4/6">
        <div className="w-3/6">
          <div>
            <h1 className="font-normal text-lg mt-1 ">
              Details about the donee:
            </h1>
            <div className="flex flex-col ml-8 mt-4">
              <div className="flex mt-2">
                ...
                <input
                  ...
                  className="input input-bordered ml-4 w-96"
                  required
                />
              </div>
              <div className="flex mt-6">
                ...
                <input
                  ...
                  className="input input-bordered ml-6 w-96"
                  required
                />
              </div>
            </div>
          ...
          <div className="form-control mt-4">
            <label className="label">
              <span className="label-text font-normal text-lg">
        ...
        <div className="w-3/6">
          <div className="form-control mt-4 w-5/6 h-4/6 border border-10 border-black border-dashed flex justify-center items-center">
            <h1 className="font-normal text-4xl">Logo goes here!</h1>
          </div>
        </div>
      </div>
