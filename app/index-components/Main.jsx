  ...
  return (
    <div className="-mt-[4.49rem] grid h-screen w-full place-items-end bg-black">
      <div className={"flex w-full justify-center absolute "}>
        ...
        >
          <blockquote className={"text-6xl"} style={{
          ...
          <p className="text-2xl text-white text-center py-16 mt-20">- Charles Dickens</p>
        </div>
      ...
      <div className="flex w-full mt-5 justify-center">
        <div
          className="mb-6 h-16 w-16 transform rounded-full outline-dotted outline-4  outline-white duration-500 hover:-translate-y-3"
