...
const Donate = (props) => {
	...
	return (
		<div className='flex min-h-full w-full fixed top-0 left-0 bg-[rgba(0,0,0,0.7)] z-10 items-center justify-center' onClick={(e) => { props.setDisplayModal(false) }}>
			<div className=' mt-4 flex h-11/12 w-3/5 z-20' onClick={(e) => e.stopPropagation()}>
				...
				<div className='flex w-1/2 flex-col rounded-r-xl px-4 bg-white'>
					{/* <div className='description-box mt-12 flex w-full flex-col justify-between py-6'> */}
