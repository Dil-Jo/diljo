                        ...
                        <form id="addDrive" onSubmit={saveDataToPocketBase} className="text-slate-800">
                            ...
                            <div className={''}>
                                <div class="relative max-w-sm">
                                    ...
                                    <input type='date' name="startingDate" id="startingDate" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date" value={formData.startingDate} onChange={handleChange} />
                                </div>
                            </div>
                            {/* --------------------------- */}
                            ...
                            <div class="relative max-w-sm">
                                ...
                                <input type="date" name="endingDate" id="endingDate" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date" value={formData.endingDate} onChange={handleChange} />
                            </div>
                        </form>
                    </div>
