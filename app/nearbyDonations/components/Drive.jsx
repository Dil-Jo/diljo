...
const Drive = ({
	...
	return (
		<div
			className={`shadow-lg flex border transition-all border-solid border-black rounded-xl mb-[1rem] active:bg-blue-900 active:text-white ${
		...
		>
			<div className='flex flex-col w-5/6'>
				<h3 className='text-[1.3rem] font-normal ml-4 mt-4'>
					Donation Name: {title}
				</h3>
			...
			<div className='modal cursor-pointer'>
				<div className='modal-box relative'>
					...
					<h3 className='text-lg font-bold'>
						Do you want to volunteer for the {title} drive
					</h3>
