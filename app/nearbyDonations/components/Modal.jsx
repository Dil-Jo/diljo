            ...
            <div className={styles.centered} >
                <form className={styles.modal}>
                    ...
                    <div className='mt-4'>
                        ...
                        <input className="text-slate-800 border-2 border-solid border-slate-600" id="starting" type='date' required onChange={(e) => setStDate(e.target.value)} />
                    </div>
                    <div className='mt-4'>
                        <label htmlFor="ending" className="text-slate-800 mx-4 mt-6">Select the ending date for the drive:</label>
                        <input className="text-slate-800 border-b-gray-800 border-2 border-solid border-slate-600" id="ending" type='date' onChange={(e) => setEndDate(e.target.value)} />
                    </div>
