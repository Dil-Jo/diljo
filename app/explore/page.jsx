	...
	return (
		<div className='mt-5 flex min-h-full w-full flex-col gap-6 px-4'>
			...
			<div className={'h-full w-full flex'}>
				<h1
					className={'text-start text-3xl font-bold tracking-tighter'}
				>
					Explore By Category
				</h1>
			</div>
	...
	return (
		<div className='card card-compact w-full bg-gradient-to-r from-slate-50 to-zinc-100 shadow-lg p-3 border-2 border-slate-100'>
			...
			<div className='card-body'>
				<h2 className='card-title truncate overflow-ellipsis'>
					{title}
				</h2>
				...
				<div className='card-actions justify-center'>
					<Link
						href={`/donation/${id}`}
						className={
							'bg-eleven px-6 py-2 rounded-md text-white border-2 border-eleven font-bold text-sm transition-all duration-200 hover:bg-opacity-10 hover:text-eleven'
						}
					>
						Donate
					</Link>
		...
		<>
			<div className={'h-full w-full'}>
				<Link href={'/charities'}>
					...
					>
						<div
							className={'h-52 w-full cursor-pointer rounded-xl'}
						>
							<div
								className={
